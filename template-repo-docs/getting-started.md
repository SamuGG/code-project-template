...
git fetch --depth=1 --no-tags https://github.com/SamuGG/code-project-template.git develop
...
- `develop` is the branch to be fetched from the remote repository
...
>
> `git fetch --depth=1 --no-tags git@github.com:SamuGG/code-project-template.git develop`
